...
tags:
  - math
  - proofs
summary: "Walks through an elegant proof that a Gaussian random projection preserves inner products in expectation, by showing E[A^T A] equals the identity matrix"
---

This post walks through an unconvential proof that the [[johnson-lindenstrauss-lemma|Johnson-Lindenstrauss Lemma]] preserves angles between vectors. I came up with this proof for a HW problem in EECS 498, and I’m not actually sure if it’s completely correct, but I think the idea is pretty cool. 
